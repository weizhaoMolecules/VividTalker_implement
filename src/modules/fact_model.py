...
class FACTModel(nn.Module):
  ...
  def forward(self, inputs, max_mask, mask_index):
    ...
    """
    print('shape of inputs listener_past', inputs["listener_past"].shape)
    print('shape of inputs audio_full', inputs['audio_full'].shape)
    print('shapeof inputs motion_full', inputs['speaker_full'].shape)
    ...
    print('shape of spearker_full_features', speaker_full_features.shape)
