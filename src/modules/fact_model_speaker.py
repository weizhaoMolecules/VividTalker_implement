...
class FACTModel(nn.Module):
  ...
  def forward(self, inputs, max_mask, mask_index):
    ...
    print('audio shape before audio_compressor {} audio full features shape {}'.format(inputs['audio_full'].shape,  audio_full_features.shape))
    ...
    print('audo shape after project {}'.format(audio_full_features.shape))
    #speaker motion
